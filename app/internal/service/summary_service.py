...
def get_weather_summary(ctx: Context, model: Nb2MosquittoModel, request: GetPredictionRequest) -> dict[int, PredictionDTO]:
...
def get_weather_detail(ctx: Context, model: Nb2MosquittoModel,
                       request: GetPredictionRequest) -> dict[int, PredictionDTO]: ...
